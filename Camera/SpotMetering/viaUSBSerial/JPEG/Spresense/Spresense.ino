/*
 *  Spresense.ino - Camera Metering Mode Sample.
 *
 *  Based on Spresense.ino from https://github.com/TomonobuHayakawa/Spresense-Playground/tree/master/IntegrationWithProcessing/LiveCamera/viaUSBSerial/JPEG
 *
 *  Author: T.Hayakawa
 *  Modified: Interested-In-Spresense
 *
  ...
  switch (err)
    {
      case CAM_ERR_NO_DEVICE:
        LOG_WRITE("Error: No Device\n");
        break;
      case CAM_ERR_ILLEGAL_DEVERR:
        LOG_WRITE("Error: Illegal device error\n");
        break;
      case CAM_ERR_ALREADY_INITIALIZED:
        LOG_WRITE("Error: Already initialized\n");
        break;
      case CAM_ERR_NOT_INITIALIZED:
        LOG_WRITE("Error: Not initialized\n");
        break;
      case CAM_ERR_NOT_STILL_INITIALIZED:
        LOG_WRITE("Error: Still picture not initialized\n");
        break;
      case CAM_ERR_CANT_CREATE_THREAD:
        LOG_WRITE("Error: Failed to create thread\n");
        break;
      case CAM_ERR_INVALID_PARAM:
        LOG_WRITE("Error: Invalid parameter\n");
        break;
      case CAM_ERR_NO_MEMORY:
        LOG_WRITE("Error: No memory\n");
        break;
      case CAM_ERR_USR_INUSED:
        LOG_WRITE("Error: Buffer already in use\n");
        break;
      case CAM_ERR_NOT_PERMITTED:
        LOG_WRITE("Error: Operation not permitted\n");
        break;
      default:
        LOG_WRITE("Error: None...!\n");
        break;
    }
}
