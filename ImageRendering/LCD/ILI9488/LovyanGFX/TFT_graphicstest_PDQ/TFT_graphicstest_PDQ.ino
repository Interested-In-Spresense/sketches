 ...
 *
 * Spresense + ILI9488 graphics test sketch using LovyanGFX.
 *
...
#define LGFX_USE_V1
#include "LGFX_SPRESENSE_ILI9488.hpp"
...
uint32_t testHaD()
{
  ...
  for (int i = 0; i < 16; i++)
  {
    uint32_t color = lcd.color888((i << 4) | i, (i << 4) | i, (i << 4) | i);
...
uint32_t testRoundRects()
{
  ...
  {
    i2 = i / 2;
    lcd.drawRoundRect(cx-i2, cy-i2, i, i, i/8, lcd.color888(i, 0, 0));
  }
...
uint32_t testFilledRoundRects()
{
  ...
  {
    i2 = i / 2;
    lcd.fillRoundRect(cx-i2, cy-i2, i, i, i/8, lcd.color888(0, i, 0));
  }
